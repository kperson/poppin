...
public extension Array {
    ...
    public func indexOf( f: (T) -> Bool) -> Int? {
        var i = 0
        var final: Int?
        for x in self {
            if f(x)  {
    ...
    *
    */
    public func mapReduce<B:Hashable, C>(m: (T) -> B, _ r: (B, [T]) -> C) -> [C]  {
